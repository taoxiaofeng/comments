...
; (function ($) {
    $.fn.layer = function () {
        ...
        // containerBox.css({ "z-index": "9999", "display": "block", "position": position, "top": "50%", "left": "50%", "transform": "translate(-50%, -50%)","transform-origin": "50% 50%"});
        containerBox.css({ "z-index": "9999", "display": "block", "position": position, "top": "30%", "left": "18%"});
